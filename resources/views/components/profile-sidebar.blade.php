<div class="container mx-auto max-w-md p-6 bg-white shadow-lg rounded-3">
    <ul class="">
        ...
        <li class="profile-links {{ request()->routeIs('profile.edit') ? 'active' : '' }}">
            <a href="{{ route('profile.edit', ['user_id' => $user['id']]) }}" class=""><i
                    class="fas fa-id-card me-2"></i> Sozlamalar</a>
        </li>

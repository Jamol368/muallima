<div class="mt-4">
    <div class="mt-4">
        <label for="teacher-category" class="block font-medium text-sm text-gray-700">Selecte Teacher Type:</label>
        <select wire:model="selectedTeacherType" id="teacher-category" name="teacher_category" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
            <option value="" selected disabled>Select Teacher Type</option>
            @if ($teacher_types)
    ...
    <div class="mt-4">
        <label for="subject" class="block font-medium text-sm text-gray-700">Select Subject:</label>

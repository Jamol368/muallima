    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="{{ route('welcome') }}" class="nav-item nav-link active">{{ __('messages.home') }}</a>
                <a href="service.html" class="nav-item nav-link">{{ __('messages.course') }}</a>
                <a href="about.html" class="nav-item nav-link">{{ __('messages.test') }}</a>
                <a href="about.html" class="nav-item nav-link">{{ __('messages.contest') }}</a>
                <a href="about.html" class="nav-item nav-link">{{ __('messages.news') }}</a>
                <a href="about.html" class="nav-item nav-link">{{ __('messages.about') }}</a>
                <a href="about.html" class="nav-item nav-link">{{ __('messages.contact') }}</a>
            </div>

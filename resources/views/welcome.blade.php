    ...
    <div class="row gx-0">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>{{ __('messages.our location') }}</small>
                <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>{{ __('messages.our phone') }}</small>
                <small class="text-light"><i class="fa fa-envelope-open me-2"></i>{{ __('messages.our email') }}</small>
            </div>
        </div>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        ...
                        <h1 class="display-1 text-white mb-md-4 animated zoomIn">Creative & Innovative Digital
                            Solution</h1>
                        <a href="#" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">{{ __('messages.brief') }}</a>
                        <a href="#" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">{{ __('messages.contact') }}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <a href="#" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">{{ __('messages.contact') }}</a>
            </div>
        ...
        <div class="flex flex-wrap justify-center g-5">
            @foreach($subject_models as $subject)
                <div class="subject wow zoomIn">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center" style="background-color: {{ $subject->color }} !important;">
                        <div>
                        ...
                        <a class="btn btn-lg btn-primary rounded" href="" style="background-color: {{ $subject->color }};">
